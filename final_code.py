...
if __name__ == "__main__":
    ...
    print(patient.CreateAccount()); doctor.display__str__()
    ...
    emr.UpdateRecord(notes="Rest + fluids", vitals={"Temp": "37.9"}); emr.display__str__()

    rx = PrescriptionsandMedications("RX-550", "PAT-001", "DOC-001", "EMR-1001", "Next Monday")
    print(rx.generatePrescription()); rx.addMedication("Paracetamol 500mg, when needed, 3 days"); rx.display__str__()

    lab = LabOrderandResults("LAB-900", "PAT-001", "DOC-001", "EMR-1001", "VIS-001", "CBC")
    print(lab.orderTest()); lab.uploadResults("Normal", "Next Monday"); lab.display__str__()

    bill = BillingandInsurance("INV-700", "PAT-001", "APT-001", 200, 150, 100)
    print(bill.generateInvoice()); bill.applyInsurance(120); print(bill.processPayment("Card")); bill.display__str__()
